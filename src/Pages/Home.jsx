...
import UserInfo from "../Data/user_info"
...
const WORDS = [UserInfo.role, "Tech Enthusiast"];
const TECH_STACK = UserInfo.skills;
const SOCIAL_LINKS = [
  { icon: Github, link: UserInfo.social.github },
  { icon: Linkedin, link: UserInfo.social.linkedin },
  { icon: Instagram, link: UserInfo.social.instagram }
];
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto min-h-screen flex flex-col justify-center pt-20">
